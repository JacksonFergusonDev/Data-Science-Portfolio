...
% --- FONT SELECTION: ROBUST LIBERTINE ---
\usepackage{libertine}        % The text font (Legacy package, more stable)
\usepackage[libertine]{newtxmath} % Math font specifically tuned to match Libertine
% ----------------------------------------
...
\author{
    ...
    \vspace{0.2em} % Adds a tiny gap before email
    \small\href{jackson.ferguson0@gmail.com}{\texttt{jackson.ferguson0@gmail.com}}
}
\date{March 2025}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\columnwidth]{image.png} % Replace with actual file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\columnwidth]{image2.png}
