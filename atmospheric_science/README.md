# [Exoplanet Atmospheric Analysis: Characterizing Structure and Composition from Descent Probe Data](exoplanet_atmospheric_analysis.ipynb)
...
### Data Processing
*Data Source: [exoplanet_data.txt](data/exoplanet_data.txt)*
